  ...
  function onCreate() {
    ...
    a.attr('id', menuId)
        ...
        .on('click', function() {
          ...
          if (menuPosition) {
            ul.removeClass('mdl-menu--bottom-left mdl-menu--bottom-right mdl-menu--top-left mdl-menu--top-right mdl-menu--unaligned')
